...
function MobileSidebar({
  ...
  return (
    <Headless.Dialog className="lg:hidden" onClose={close} open={open}>
  ...
  return (
    <div className="relative isolate flex min-h-svh w-full flex-col bg-background">
      ...
      <main className="flex flex-1 flex-col pb-2 lg:px-2">
        <div className="grow p-6 lg:rounded-lg lg:bg-background lg:p-10 lg:shadow-xs lg:ring-1 lg:ring-border">
